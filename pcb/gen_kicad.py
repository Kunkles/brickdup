...
PINS = {
    ...
    "brickdup:MP9486A": {
        ...
        "9": (0.0, 0.0),     # exposed thermal pad -> GND
    },
}
...
# ---- nets: name -> [(ref, pin), ...] ----
NETS = {
    "VBAT":  [("U1","3"),("Cin1","1"),("Cin2","1"),("Cin3","1"),("D2","1"),("REN1","1"),("R1","1"),("J1","1")],
    "GND":   [("U1","8"),("U1","9"),("Cin1","2"),("Cin2","2"),("Cin3","2"),("D2","2"),("D1","2"),("Cout1","2"),("Cout2","2"),("Cout3","2"),("RFB2","2"),("R2","2"),("C1","2"),("J1","2"),("J2","3"),("REN2","2")],
    "SW":    [("U1","5"),("L1","1"),("D1","1"),("Cbst","1")],
    "+5V":   [("L1","2"),("Cout1","1"),("Cout2","1"),("Cout3","1"),("RFB1","1"),("Cff","1"),("J2","1")],
    "BST":   [("U1","4"),("Cbst","2")],
    "FB":    [("U1","1"),("RFB1","2"),("RFB2","1"),("Cff","2")],
    # datasheet: for a normal (non-dimming) buck, tie DIM (6) to EN (7)
