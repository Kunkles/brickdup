...
mapping lands MIRRORED. Found 2026-09-02 via the OLED window printing 5 mm
...
- **East wall**: J1 VBAT JST mouth (LEMO pigtail) + the Heltec **USB-C**
  ...
  - **USB: NO opening in this version (decided 2026-09-02).** The port is
...
**Current shell (v0.6, 2026-09-02): button wells DROPPED for now** — the lid
...
- **SW1 power switch (decided + ORDERED 2026-09-02)**: round snap-in rocker
...
## 4a. Lid retention — hook west, screw east (decided 2026-09-02)
...
- **SHRINK TEST (2026-09-02): `bay_l` 20 → 12, case 87.8 → 79.8 mm.** The
...
- **Original rationale (2026-09-02), still the reason the bay exists:**
...
- **LEMO in the bay's east wall** — dry-fit corrected 2026-09-02 (v2):
...
**DECIDED (2026-09-02): back to the v11-style perpendicular bulkhead.** The
